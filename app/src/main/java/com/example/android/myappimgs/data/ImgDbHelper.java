...
public class ImgDbHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        ...
        final String SQL_CREATE_WEATHER_TABLE2 =

                "CREATE TABLE " + ImgContract.TableProducts.TABLE_NAME + " (" +
                         ...
                         */
                        ImgContract.TableProducts._ID               + " INTEGER PRIMARY KEY AUTOINCREMENT, " +

/*
                        WeatherEntry.COLUMN_DATE       + " INTEGER NOT NULL, "                 +
*/

                        ImgContract.TableProducts.COLUMN_IMG_ADDR   +       "  TEXT , "

                        + ImgContract.TableProducts.FORK + " integer,"
                        + " FOREIGN KEY ("+ImgContract.TableProducts.FORK +") REFERENCES "+ImgContract.WeatherEntry.TABLE_NAME+"("+ImgContract.WeatherEntry._ID +"));";
...
*/
        ...
        final String SQL_CREATE_WEATHER_TABLE =
                ...
                "CREATE TABLE " + ImgContract.WeatherEntry.TABLE_NAME + " (" +
                        ...
                        WeatherEntry.IMG_ADDR       + " TEXT, "                 +


                            WeatherEntry.SIGHT_NAME   + " TEXT  ,"                    +


                        WeatherEntry.TRIP_NAME   + " TEXT "                    +");";
                      /*  WeatherEntry.COLUMN_PRESSURE   + " REAL NOT NULL, "                    +
